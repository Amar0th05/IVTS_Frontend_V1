let EmpId;
  ...
  console.log("Loaded User emp:", storedUser);

  if (storedUser) {
    EmpId = storedUser.Employee_ID || '—';
  } else {
...
function formatDate(dateStr) {
   ...
   async function fetchLeaveSummary() {
    try {
        const leaves = await api.getAllLeaveById(EmpId);
        table.clear();
        ...
        leaves.forEach(leave => {
            ...
            // "leaveStartDate": "2025-11-12T00:00:00.000Z",
            // "leaveEndDate": "2025-11-13T00:00:00.000Z",
            // "totalDays": 2,
            // "Reason": "fdjkl;l",
            // "Document": null,
            // "rejectionReason": "No reason provided",
            // "employeeId": "IC43221",
            // "employeeName": "KOWSHIK M",
            // "month": "November",
            // "leaveType": "SL",
            // "Manager": "Pradhiksha R S",
